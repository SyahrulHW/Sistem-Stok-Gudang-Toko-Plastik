...
@section('breadcrumb', 'Barang Masuk / Tambah')
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-slate-800">
                    <i class="fa-solid fa-circle-arrow-down text-emerald-500 me-2"></i> Catat Transaksi Barang Masuk
                </h6>
                ...
                <form action="{{ route('barang-masuk.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nomor_transaksi" id="nomor_transaksi" class="form-control @error('nomor_transaksi') is-invalid @enderror" placeholder="Contoh: BM-20231012-0001" value="{{ old('nomor_transaksi', $autoNomor) }}" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="jumlah" id="jumlah" class="form-control @error('jumlah') is-invalid @enderror" placeholder="Contoh: 50" value="{{ old('jumlah') }}" min="1" required>
                            @error('jumlah')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="bg-light p-3 border rounded mb-4" style="font-size: 0.8rem; color: #475569;">
                        ...
                        <strong>Efek Transaksi</strong>: Setelah Anda mengklik tombol simpan, stok produk yang terpilih akan **otomatis bertambah** sejumlah kuantitas yang dicatat.
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        // Initial calculation trigger if pre-filled values exist
        calculateTotal();
    });
</script>
@endsection
