...
@section('breadcrumb', 'Barang Keluar / Tambah')
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-slate-800">
                    <i class="fa-solid fa-circle-arrow-up text-rose-500 me-2"></i> Catat Transaksi Barang Keluar
                </h6>
                ...
                <form action="{{ route('barang-keluar.store') }}" method="POST" id="barangKeluarForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nomor_transaksi" id="nomor_transaksi" class="form-control @error('nomor_transaksi') is-invalid @enderror" placeholder="Contoh: BK-20231012-0001" value="{{ old('nomor_transaksi', $autoNomor) }}" required>
                            ...
                            <select name="product_id" id="product_id" class="form-select @error('product_id') is-invalid @enderror" required>
                                ...
                                @foreach($products as $product)
                                    <option value="{{ $product->id }}" 
                                        ...
                                        {{ $product->nama_produk }} ({{ $product->kode_produk }}) - Tersedia: {{ $product->stok }} {{ $product->satuan }}
                                    </option>
                                @endforeach
                            </select>
                            @error('product_id')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="jumlah" id="jumlah" class="form-control @error('jumlah') is-invalid @enderror" placeholder="0" value="{{ old('jumlah') }}" min="1" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" placeholder="Contoh: Kirim ke Cabang, Penjualan retail" value="{{ old('keterangan') }}">
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
